...
public class CookieSplit {
	...
	private String cookieString = "USERNM=brown;REMEMBER=Y;TEST=T;";
	public static void main(String[] args) {
		
		CookieSplit cookieSplit = new CookieSplit();
		logger.debug(cookieSplit.getCookieValue("USERNM"));   //기대되는 값 BRWON
		logger.debug(cookieSplit.getCookieValue("REMEMBER")); //기대되는 값 Y
